    ...
    <div class="wrapper">
        ...
        <form action="<?PHP echo base_url(). 'index.php/Users/uploadimage12' ?>"
          method="post" enctype="multipart/form-data" name="employee">  
            ...
            <div class="flex">
                ...
                <!--full name field-->
                    <div class="field-container">
                        ...
                        <input type="text" name="emp_name"   pattern="^([a-zA-Z]{2,} ?)+$" id="emp_name" placeholder="Your  emp_name" onkeypress="return  allowOnlyLetters( event,this);" maximum =10 characters required />
