  ...
  <div class="container">
    ...
    <div class="collection-list">
      <ul>
        ...
        <li><img src="http://www.galaxyjewellers.com/sites/default/files/images/product/PZ078-GSB-face.png" style="width: 180px"/>
          <div class="list-head">
            <h3>Pendants</h3>
            <span>The description of the item.</span>
          </div>
  ...
  <div class="container">
    ...
    <div class="collection-list clearfix">
      <ul>
        ...
        <li><img src="http://waj.com.pk/wp-content/uploads/2016/05/earrings.png" style="width: 180px"/>
          <div class="list-head">
            <h3>Earrings</h3>
            <span>The description of the item.</span>
          </div>
