...
<div class="container">
  ...
  <div class="row" >
    <div class="col-sm-10 col-sm-offset-4" >
      ...
      <hr>
      <form method="post" action="<?php echo site_url('Users/update/').$user->id ?>" method="post" enctype="multipart/form-data" name="editform"> 


        
        <label>Gold Type:</label>
        <input type="text" value="<?php echo $user->gold_type; ?>" name="gold_type" placeholder="enter the gold_type" id="gold_type" onkeypress="return allowOnlyLetters(event,this);" maximum =10 characters required />

        
        
        <label>Weight:</label>
        <input type="text" value="<?php echo $user->weight; ?>" placeholder="Enter weight" name="weight" id="weight" onkeypress="return isNumber(event);" required />
        
        
        
        <label>Price:</label>
        <input type="text" class="form-control" value="<?php echo $user->price; ?>" name="price" 
        id="price" onkeypress="return isNumber(event);" required /> 
        
        <label >Upload the file:</label>
        <input type='file' class="form-control" value="<?php echo $user->file; ?>" name='picture' id="picture" > <br/>   
