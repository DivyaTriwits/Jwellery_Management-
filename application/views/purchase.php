      ...
      <div class="col-sm-4 col-sm-offset-4">
        ...
        <div class="dropdown">  
         ...
         <select name="gold_type" id="gold_type" class="form-control input-lg">
          <option value="<?php echo $user->id; ?>">'<?php echo $user->gold_type; ?>'</option>';
        </select>
      </div> 
      <br> 
  ...
  function getTotalPrice() {
    ...
    var pricePerItem = Number(document.getElementById("price").value);
    var discountPercentage = Number(document.getElementById("discount").value);

    // Calculate the total price with discount
    var totalValue = pricePerItem * quantity * ((100 - discountPercentage) / 100);
