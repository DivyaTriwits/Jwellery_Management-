...
<option value = "Bangle">Bangle  
      ...
      <div class="input__box">
        ...
        <input type="text" placeholder="Enter units" name="units" id="units" onkeypress="return isNumber(event);" required /></div>
      <div class="input__box">
        <span class="details">Division</span>
        <input type="text" placeholder="Enter division" name="division" id="division" onkeypress="return (event);" required />
      </div>
      <div class="input__box">
