...
<div class="row">
  <div class="column">
     <img src="<?php echo base_url('admin/uploads/images/'.$user->file); ?>"width="500" height="500"> <h1>Gold Type:-<?php echo $user->gold_type; ?> <h1>Quantity:-<?php echo $user->quantity; ?></h1>
